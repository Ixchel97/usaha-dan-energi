...
import { columnsFromBackend } from './DnDList1';
...
const DnD1 = () => {
                ...
                {(provided, snapshot) => (
                  ...
                  >
                    ...
                    {column.items.map((item, index) => (
                      <TaskCard1 key={item} item={item} index={index} />
                    ))}
              ...
              <Droppable key={columnId} droppableId={columnId}>
                {(provided, snapshot) => (
                  ...
                  >
                    ...
                    <table>
                    {column.items.map((item, index) => {
                      const correctOrder = ['Menentukan besar massa mobil Budi', 'Menentukan Kecepatan Mobil Budi', 'Menentukan besar energi kinetik yang dihasilkan mobil Budi' ];
  ...
  return (
    <>
      <tr key={item}>
        <td>
          <TaskCard1 item={item} index={index} />
        </td>
        <td>
          {isCorrectOrder ? (
